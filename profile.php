                            ...
                            <div id="faq" class="panel-group">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h5 class="panel-title"><span>1</span> <a data-toggle="collapse" data-parent="#faq" href="#my-account-1">Editar tu Información </a></h5>
                                    </div>
												...
												<div class="billing-information-wrapper">
													...
													<div class="billing-back-btn">
														...
														<div class="billing-btn">
															<button type="submit" id="profile_submit">Guardar</button>
														</div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h5 class="panel-title"><span>2</span> <a data-toggle="collapse" data-parent="#faq" href="#my-account-2">Cambiar Contraseña </a></h5>
                                    </div>
                                            ...
                                            <form method="post" id="frmPassword">
												<div class="billing-information-wrapper">
													...
													<div class="billing-back-btn">
														...
														<div class="billing-btn">
															<button type="submit" id="password_submit">Guardar</button>
														</div>
													</div>
