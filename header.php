                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="main-menu">
                                <nav>
                                    <ul>
                                        <li><a href="<?php echo FRONT_SITE_PATH?>">Inicio</a></li>
                                        <li><a href="<?php echo FRONT_SITE_PATH?>shop">Comprar</a></li>
                                        <li><a href="<?php echo FRONT_SITE_PATH?>about-us">Nosotros</a></li>
                                        <li><a href="<?php echo FRONT_SITE_PATH?>contact-us">Contacto</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
